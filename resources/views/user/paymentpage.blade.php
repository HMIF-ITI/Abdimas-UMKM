                ...
                <form action="{{ url('/booking') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputName" aria-describedby="name" value="" name="name">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail" class="form-label">Email</label>
                            <input type="email" class="form-control" id="exampleInputEmail" value="" name="email">
                        </div>
                        <div class="mb-3">
