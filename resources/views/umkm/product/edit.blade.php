        ...
        <div class="col">
            ...
            <form action="/umkm/product/{{ $product->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select  @error('umkm_id') is-invalid @enderror" aria-label="Default select example" name="umkm_id" id="umkm_id">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select  @error('category_product_id') is-invalid @enderror" aria-label="Default select example" name="category_product_id" id="category_product_id">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="exampleInputPassword1" name="price" value="{{ $product->price }}">
                    @error('price')
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('stock') is-invalid @enderror" id="exampleInputPassword1" name="stock" value="{{ $product->stock }}">
                    @error('stock')
                    <div class="invalid-feedback">
